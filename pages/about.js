...
export default function AboutPageRender() {
  return (
    <AppTemplate title="About Open Publishing Platform">
      <div className="mastheadContainer">
        <div className="readingWidthLimitedContainer">
          <h1>
            About Open Publishing Platform
          </h1>
          <p>Open Publishing Platform is an open solution to the typical journal publishing workflow.</p>
        </div>
      </div>
